            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                <p className="text-xs text-gray-500">
                  © 2023 MidasBuy. All rights reserved. All trademarks referenced herein are the properties of their respective owners.
                </p>
              </div>
              <div className="flex items-center space-x-3">
                <span className="text-xs text-gray-500">Secure Payment:</span>
                <img src="/lovable-uploads/96365d0d-ed1e-4b9a-84fd-e6899011aaa7.png" alt="Visa" className="h-6" />
                <img src="/lovable-uploads/ef06efa0-0fb0-41e1-9d97-fdcb26ddaea9.png" alt="Mastercard" className="h-6" />
                <img src="/lovable-uploads/63317b35-19fb-42f4-ac10-850eba38acd7.png" alt="PayPal" className="h-5" />
              </div>
            </div>
          </div>
        </div>
